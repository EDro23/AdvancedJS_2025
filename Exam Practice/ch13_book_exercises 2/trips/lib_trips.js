...
const trips = [];  // array to hold Trip objects

const tripModule = {       

    push(trip) {
        if (trip instanceof Trips) {  // only add valid Trip objects
            trips.push(trip);
        } else {
...
export default tripModule;  // export the Trips class for use in other modules